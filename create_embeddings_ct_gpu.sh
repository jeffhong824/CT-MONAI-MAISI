#!/bin/bash
# Create latent embeddings from CT images using pretrained VAE
# Usage: ./create_embeddings_ct_gpu.sh or GPU_IDS="0,1,2,3" ./create_embeddings_ct_gpu.sh

# Specify GPU IDs (comma-separated, no spaces)
GPU_IDS=${GPU_IDS:-"0,1,2,3"} # Default to GPU 0,1,2,3

echo "=========================================="
echo "Creating Latent Embeddings"
...
echo "Embedding creation finished at $(date)"
